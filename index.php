  ...
  <body>
        <div class="container font12" align="center" style="margin:0 auto;width:500px;height:480px;margin-top:120px;background-color: white;box-shadow: 5px 10px 8px 8px #9f9e9a;">
          <form action="Check/checklogin.php" id="form1" method="POST">
                <div class="row">
                    <div class="col-md-12">
                      <img src="image/<?php echo $row['img_path']; ?>" alt="" width="180px" style="padding-top: 15px;">
                    </div>
                    <div class="col-md-12">
                    ...
                    <div class="col-md-12"><br>
                        <button type="submit" class="btn btn-outline-primary" style="width: 85%">
                            ເຂົ້າສູ່ລະບົບ
                        </button>
                    </div>
                    <div class="col-md-12 font12" style="color: #35AADE;"><br>
                      <b>
                          <?php echo $row['name']; ?>
                      </b> <br>
                    </div>
          ...
          if(isset($_GET['login'])=='found'){
            echo'<script type="text/javascript">
            swal("", "ອີເມວ ຫຼື ລະຫັດຜູ້ໃຊ້ບໍ່ຖືກຕ້ອງ ກະລຸນາລອງໃໝ່ອີກຄັ້ງ !", "error");
            </script>';
          }
          if(isset($_GET['permission'])=='found'){
            echo'<script type="text/javascript">
            swal("", "ທ່ານບໍ່ມີສິດໃຊ້ລະບົບ !", "error");
            </script>';
          }
        ?>
  </body>
