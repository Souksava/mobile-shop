<?php
   ...
   if($_SESSION['ses_id'] == ''){
    ...
    $sqlsell = "select sell_id,cus_name,sell_date,sell_time,amount,status_cash,s.img_path,sell_type,cupon_price,cupon_key,emp_name from sell s left join customers c on s.cus_id=c.cus_id left join employees e on s.emp_id=e.emp_id where s.sell_id='$sell_id';";
			...
			<div class="col-md-8">
                ...
                <div align="right">
                    ...
                    <div class="col-md-12">
                        ...
                        <label style="color: #7E7C7C;font-size: 12px;">ຄູປ໋ອງສ່ວນລົດ: <?php echo number_format($rowsell['cupon_price'],2); ?> ກີບ</label>                   
                    </div>
                </div>
            </div>
