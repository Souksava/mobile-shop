<?php 
            require '../../ConnectDB/connectDB.php';
                $id = $_GET['id'];
                $sqlck = "select * from sell where cus_id='$id';";
                $resultck = mysqli_query($link, $sqlck);
               
                if(mysqli_num_rows($resultck) > 0){
                    echo"<script>";
                    echo"window.location.href='customer.php?del=not';";
                    echo"</script>";
                }
               else{
                    ...
                    {
                        echo"<script>";
                        echo"window.location.href='customer.php?del2=found';";
                        echo"</script>";
                    }
                    else{
                        echo"<script>";
                        echo"window.location.href='customer.php?del2=success';";
                        echo"</script>";
                    } 
               }
?>
